...
{
    public partial class FrmInventoryViewOnline : Form
    {
        ...
        protected void GetInventoryItemsList()
        {
            ...
            try
            {
                DT = invhandler.InventoryViewOnline(Program.iInvHeader.InvHdrID,isearchterm,iGetLastrecs);
                ...
                if (DT.Rows.Count > 0)
                {
                    ...
                    DGListStyle.MappingName = "DTINVENTORY";
        ...
        protected void GoInventory()
        {
            ...
            WMSForms.FrmInventoryOnline = new FrmInventoryOnline(iinvid);
