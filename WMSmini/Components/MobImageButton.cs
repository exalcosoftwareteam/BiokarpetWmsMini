...
namespace WMSMobileClient.Components
{
        ...
        public class MobImageButton : Control
        {
            ...
            { get { return backimage; } set { backimage = value; } }

            public MobImageButton()
            {
                bPushed = false;
            ...
            public void ChangeImage(Image newimage)
            {
                ...
                m_bmpOffscreen = null;
                PaintImage();
                Graphics gxOffnew = Graphics.FromImage(m_bmpOffscreen);
                gxOffnew.DrawImage(m_bmpOffscreen, 0, 0);

                //Image.FromHbitmap( (m_bmpOffscreen);
            }
